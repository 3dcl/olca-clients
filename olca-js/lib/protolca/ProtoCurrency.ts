...
export interface ProtoCurrency {
  /**
  ...
  'referenceCurrency'?: (_protolca_ProtoRef | null);
}

export interface ProtoCurrency__Output {
  /**
   * The reference ID (typically an UUID) of the entity.
   */
  'id'?: (string);
  ...
  'referenceCurrency'?: (_protolca_ProtoRef__Output);
}
