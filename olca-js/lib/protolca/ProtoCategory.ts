...
import type { ProtoCategoryType as _protolca_ProtoCategoryType } from '../protolca/ProtoCategoryType';
...
export interface ProtoCategory {
   ...
   */
  'modelType'?: (_protolca_ProtoCategoryType | keyof typeof _protolca_ProtoCategoryType);
}
 ...
 * which is then the parent category of this category (uff).
 */
export interface ProtoCategory__Output {
  /**
   * The reference ID (typically an UUID) of the entity.
   */
  'id'?: (string);
   ...
   * The type of models that can be linked to the category.
   */
  'modelType'?: (_protolca_ProtoCategoryType);
}
