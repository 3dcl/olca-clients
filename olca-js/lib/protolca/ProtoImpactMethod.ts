 ...
 */
export interface ProtoImpactMethod {
  /**
   ...
   */
  'impactCategories'?: (_protolca_ProtoRef)[];
  /**
   * The normalization and weighting sets of the method.
   */
  'nwSets'?: (_protolca_ProtoNwSet)[];
}

/**
 * An impact assessment method.
 */
export interface ProtoImpactMethod__Output {
  /**
   * The reference ID (typically an UUID) of the entity.
   */
  'id'?: (string);
   ...
   * The impact categories of the method.
   */
  'impactCategories'?: (_protolca_ProtoRef__Output)[];
  /**
   * The normalization and weighting sets of the method.
   */
  'nwSets'?: (_protolca_ProtoNwSet__Output)[];
}
