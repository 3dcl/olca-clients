...
import type { DataFetchServiceClient as _protolca_services_DataFetchServiceClient, DataFetchServiceDefinition as _protolca_services_DataFetchServiceDefinition } from './protolca/services/DataFetchService';
...
export interface ProtoGrpcType {
  ...
  protolca: {
    ...
    services: {
      CategoryTree: MessageTypeDefinition
      DataFetchService: SubtypeConstructor<typeof grpc.Client, _protolca_services_DataFetchServiceClient> & { service: _protolca_services_DataFetchServiceDefinition }
      FindRequest: MessageTypeDefinition
      GetAllRequest: MessageTypeDefinition
      GetAllResponse: MessageTypeDefinition
      GetCategoryContentRequest: MessageTypeDefinition
      GetCategoryTreeRequest: MessageTypeDefinition
      GetCountRequest: MessageTypeDefinition
      GetCountResponse: MessageTypeDefinition
      GetDescriptorsRequest: MessageTypeDefinition
